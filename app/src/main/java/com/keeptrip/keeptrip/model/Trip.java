...
public class Trip implements Parcelable {
    ...
    public ContentValues tripToContentValues(){
        ...
        contentValues.put(KeepTripContentProvider.Trips.START_DATE_COLUMN, DateUtils.databaseDateToString(startDate));
        contentValues.put(KeepTripContentProvider.Trips.END_DATE_COLUMN, DateUtils.databaseDateToString(endDate));
        contentValues.put(KeepTripContentProvider.Trips.TITLE_COLUMN, title);
